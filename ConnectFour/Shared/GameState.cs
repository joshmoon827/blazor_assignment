...
public class GameState
{
    ...
    static GameState() => CalculateWinningPlaces();
    ...
    public void ResetBoard() => TheBoard = new List<int>(new int[42]);

    static byte ConvertLandingSpotToRow(int landingSpot) => (byte)(Math.Floor(landingSpot / (decimal)7) + 1);
}